...
for (const difficulty of ['apprentice','journeyman'] as const) {
 const r=runHeadless(SERVICE_CALL,{difficulty,heroEnabled:true,microJeff:true,callEarly:true,maxSeconds:5400,buildOrder:['jayjay','torch','vent','washer','expansion'],skills:[]});
