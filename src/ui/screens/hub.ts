    ...
    el.append(
      h(
        ...
        h(
          ...
          h(
            'p',
            {
              class: 'lede',
              text: metaLocked
                ? 'First call is Crawlspace Chaos — take the job below. Browse the Supply Store and Kit now. The locker opens after a clear.'
        ...
        h(
          'div',
          { class: 'hub-actions' },
          metaBtn(app, 'kit', 'Kit', '8 heroes', false, metaTip),
