...
h('li', { html: '<b>Q</b> <b>E</b> <b>R</b> <b>T</b> <b>C</b> are your selected hero’s five abilities. Select a tool and press <b>V</b> to fire its active (costs spare parts from pops). <b>X</b> torch rain · <b>D</b> Summon Logan · <b>Space</b> call the wave · <b>F</b> 1×/2×/3× · <b>P</b> pause.' }),
        h('li', { html: '<b>D</b> summons <b>Logan</b> onto a route for 18 seconds — every hero shares him. <b>X</b> drops three fire dumps on a point you pick. Select a barricade or barracks and press <b>G</b> to move its hold / rally point. Level-three towers can choose one of two <b>elite specializations</b>.' }),
