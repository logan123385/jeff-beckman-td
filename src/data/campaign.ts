...
export const CAMPAIGN_LOCATIONS: Record<string, CampaignLocation> = {
  ...
  liftStation: { x: 83, y: 74, region: 'The wetland', objective: 'Drain the rising floodwaters.', tactic: 'Cover both routes. A second rally point matters more than an isolated expensive tower.' },
  mechanicalRoom: { x: 66, y: 53, region: 'The works', objective: 'Take back the machinery district.', tactic: 'Strip armor first, then concentrate fire. Save Summon Logan for a leak through the line.' },
