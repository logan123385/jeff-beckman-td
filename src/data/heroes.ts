...
export const HEROES: Record<HeroId, HeroDef> = {
  ...
  mike: {
    ...
    abilities: [
      ...
      { name: 'Plunger Rain', short: 'Plunger bombardment', description: 'Click the yard within 280. Nine plungers rain into a 90-radius area over 4.5 seconds, each dealing 32 splash damage.', cooldown: 42, glyph: 'rain', target: true, aim: 'ground', castRange: 280, cast: 1.05,
  ...
  chris: {
    id: 'chris', name: 'Mr. Chris', title: 'Saw teeth. Tee times. Sticky lies.', style: 'Melee skirmisher',
    description: 'Carve into crowds with a reciprocating saw, bank a golf shot through enemies, and leave sticky sand traps that grind a lane to a halt.',
    ...
    abilities: [
      { name: 'Sand Trap', short: 'Sticky slow zone · 6.5s', description: 'Dump a 100-radius sand trap for 6.5 seconds. Ground enemies move 55% slower and take 10 damage per second.', cooldown: 24, glyph: 'sand', cast: .8,
        ranks: ['Wider trap. Stickier sand.', 'Lasts longer. Deeper grind.', 'Maximum trap. The lane stops cold.'] },
